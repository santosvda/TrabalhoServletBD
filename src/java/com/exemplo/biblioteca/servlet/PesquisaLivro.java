...
public class PesquisaLivro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<p><ul class=\"list-group\">\n" +
                        "  <li class=\"list-group-item\">Java- Como Programar - 10ª Ed</li>\n" +
                        "  <li class=\"list-group-item\">PHP na Prática</li>\n"+
                        "  <li class=\"list-group-item\">Building Reactive Microservices in Java</li>\n" +
                        "  <li class=\"list-group-item\">Migrating to Microservice Databases</li>\n"+                         
                        "</ul><p><BR><a class=\"btn btn-outline-primary\" href=\"#\" role=\"button\">Biblioteca</a>");
